...
import { TrendUp, Trophy, Lightning, Star, House, Bell, Shield, Users, UsersThree, UsersFour, Rocket, Globe, Info } from "@phosphor-icons/react"
            ...
            <SheetContent side="left" className="w-72 max-w-full p-0 md:hidden rounded-none h-full" style={{ borderRadius: 0 }}>
                <div className="h-full overflow-y-auto">
                    <nav className="flex flex-col gap-2 p-6">
                        ...
                        <Link href="/groups" onClick={() => trackUserAction("navigation_click", { destination: "groups", source: "mobile_nav" })} className={`flex items-center gap-3 px-3 py-2 rounded-none font-medium text-base ${pathname.startsWith("/groups") ? "text-purple-600 dark:text-purple-400" : "text-gray-700 dark:text-gray-200"}`}> <UsersFour weight="duotone" className="w-5 h-5" />Groups</Link>
