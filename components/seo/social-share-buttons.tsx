...
import { getSocialSharingLinks } from '@/lib/seo/social-metadata';
...
interface SocialShareButtonsProps {
    ...
    className?: string;
    showLabels?: boolean;
    platforms?: ('twitter' | 'facebook' | 'linkedin' | 'reddit' | 'email' | 'whatsapp' | 'telegram' | 'copy')[];
}

/**
 * Component for displaying social sharing buttons
 */
export default function SocialShareButtons({
    ...
    const sharingLinks = getSocialSharingLinks(shareUrl, title, description, hashtags);
