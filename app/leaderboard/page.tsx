...
import { Zap, Trophy, Medal, Crown, Award, TrendingUp, Users, Heart } from "lucide-react"
import Link from "next/link"

const LEADERBOARD_CATEGORIES = [
  { label: "Points", value: "points", icon: Zap },
...
export default function LeaderboardPage() {
  ...
  const getCurrentData = () => {
    return mockLeaderboardData[selectedCategory as keyof typeof mockLeaderboardData] || mockLeaderboardData.points
  }
