...
const MOODS = [
  ...
  { emoji: "❤️", label: "Love", value: "love", color: "bg-pink-100 text-pink-800" },
  { emoji: "😰", label: "Anxious", value: "anxious", color: "bg-purple-100 text-purple-800" },
  { emoji: "🤔", label: "Confused", value: "confused", color: "bg-gray-100 text-gray-800" },
  { emoji: "😴", label: "Tired", value: "tired", color: "bg-indigo-100 text-indigo-800" },
  { emoji: "🎉", label: "Excited", value: "excited", color: "bg-green-100 text-green-800" },
]
