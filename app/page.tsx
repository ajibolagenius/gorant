      ...
      <div className="container mx-auto px-4 py-8 max-w-7xl">
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-3 space-y-6">
            {/* Rant of the Day */}
            {rantOfTheDay && (
              <Card className="shadow-lg border-0 bg-gradient-to-r from-yellow-100 to-orange-100 dark:from-yellow-900/30 dark:to-orange-900/30 dark:border-yellow-800/30">
                <CardHeader>
                  <div className="flex items-center space-x-2">
                ...
                <CardContent>
                  <div className="flex items-start space-x-3">
                    ...
                    <div className="flex-1">
                      <p className="text-gray-800 dark:text-gray-200 mb-2">{rantOfTheDay.content}</p>
